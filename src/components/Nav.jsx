...
const Nav = () => {
  ...
  return (
    <header className='shadow-md fixed top-0 left-0 right-0 z-50 py-2 text-white'>
      <Wrapper>
        <div>
          <nav className='flex justify-between items-center py-4 mx-2'>
            <div to="/" className="flex items-baseline text-primary">
              <h1 className=' text-xl hover:cursor-pointer  bg-[#52a286] rounded-full w-10 h-10 text-center p-1'>BH</h1>
            ...
            <div className='hidden md:flex space-x-2 lg:space-x-9 md:space-x-5'>
              <a href="#home" className='hover:cursor-pointer  hover:border-b-2 '>Home</a>
              <a onClick={handlePropertiesClick} className='hover:cursor-pointer hover:border-b-2'>Properties</a>
              <a href="#about us" className='hover:cursor-pointer hover:border-b-2'>About Us</a>
              <a href="#blog" className='hover:cursor-pointer hover:border-b-2'>Blog</a>
              <a href="#contact us" className='hover:cursor-pointer  hover:border-b-2'>Contact Us</a>
            </div>
          ...
          {menuOpen && (
            <div className='bg-[#24282c] space-y-2 p-4'>
              ...
              <a href="#home" className='hover:cursor-pointer text-lg'>Home</a>
              <a onClick={handlePropertiesClick} className='hover:cursor-pointer text-lg'>Properties</a>
              <a href="#about us" className='hover:cursor-pointer text-lg'>About Us</a>
              <a href="#blog" className='hover:cursor-pointer text-lg'>Blog</a>
              <a href="#contact us" className='hover:cursor-pointer text-lg'>Contact Us</a>
            </div>
